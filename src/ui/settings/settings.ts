...
const SETTINGS: SettingDefinition[] = [
    ...
    },
    {
        ...
        category: "automation",
        name: "DH2E.Settings.WarbandInventoryAccess.Name",
        hint: "DH2E.Settings.WarbandInventoryAccess.Hint",
        scope: "world",
        config: true,
        type: String,
        default: "all",
        choices: {
            all: "DH2E.Settings.WarbandInventoryAccess.All",
    ...
    },
    {
        key: "enableVFX",
        category: "display",
        name: "DH2E.Settings.EnableVFX.Name",
        hint: "DH2E.Settings.EnableVFX.Hint",
        scope: "client",
        config: true,
        type: Boolean,
        default: true,
    },
    {
        key: "vfxIntensity",
        category: "display",
        name: "DH2E.Settings.VFXIntensity.Name",
        hint: "DH2E.Settings.VFXIntensity.Hint",
        scope: "client",
        config: true,
        type: String,
        default: "normal",
        choices: {
            minimal: "DH2E.Settings.VFXIntensity.Minimal",
            normal: "DH2E.Settings.VFXIntensity.Normal",
            full: "DH2E.Settings.VFXIntensity.Full",
        },
    },
    {
        key: "enableCombatHUD",
