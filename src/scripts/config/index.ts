...
export const DH2ECONFIG: DH2EConfig = {
    ...
    availabilityTiers: {
        ...
        scarce: { label: "DH2E.Availability.Scarce", modifier: -10 },
        rare: { label: "DH2E.Availability.Rare", modifier: -20 },
        veryRare: { label: "DH2E.Availability.VeryRare", modifier: -30 },
        extremelyRare: { label: "DH2E.Availability.ExtremelyRare", modifier: -40 },
        nearUnique: { label: "DH2E.Availability.NearUnique", modifier: -50 },
        unique: { label: "DH2E.Availability.Unique", modifier: -60 },
    },
